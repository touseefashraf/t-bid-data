...
@Component({
    selector: 'app-add-other-doc',
    templateUrl: './add-other-doc.component.html',
    styleUrls: ['./add-other-doc.component.css']
})
export class AddOtherDocComponent implements OnInit {
    ...
    downloadDocument(documentId: number, file: any) {
        this.dataService.downloadDocument(this.projectId, 'other', documentId).subscribe((resp: any) => {
            const binaryData = []
