...
export class AddPlanDocComponent implements OnInit {
    ...
    constructor(
        ...
        this.spinnerSVG = `/assets/images/rolling.svg`
    }
        ...
        fetch(fileData)
            ...
            .then(blob => {
                ...
                this.ds.uploadFile(formData).subscribe((resp: any) => {
                    this.ds.planDoc.next(this.ds.planDoc.getValue()+1)
    ...
    fileDragStart(e: any): void {
        e.preventDefault()
        document.getElementsByClassName('images-container2')[0].classList.add('highlight')
    }

    fileDragEnd(e: any): void {
        e.preventDefault()
        document.getElementsByClassName('images-container2')[0].classList.remove('highlight')
    }
    ...
    browseFiles(event: any) {
        ...
        const element = document.getElementById('plan-files')
        element.click()
    }
